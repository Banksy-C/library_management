<template>
  <div class="Admin">
    ...
    <div style="margin-top: 10px; margin-bottom: 15px">
      ...
      <el-button style="float: right; margin-right: 70px" type="primary" @click="$router.push('/addAdmin')" plain><i class="el-icon-plus"></i> 新增</el-button>
    </div>
...
<!--      <el-table-column prop="update" label="更新时间"></el-table-column>-->
      ...
      <el-table-column label="操作" ><!--align="right"-->
        ...
        <template v-slot="scope">
          <el-button type="primary" @click="$router.push('/editAdmin?userid=' + scope.row.userid)">编辑</el-button>
